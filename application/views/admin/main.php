...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/lte/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/lte/plugins/summernote/summernote-bs4.css">
  <!-- Google Font: Source Sans Pro -->
  <link href="<?php echo base_url(); ?>/lte/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
</head>
...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="<?php echo base_url(); ?>/lte/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="<?php echo base_url(); ?>/lte/index3.html" class="brand-link">
      <img src="<?php echo base_url(); ?>/lte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url(); ?>/lte/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>/lte/index.html" class="nav-link active">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="<?php echo base_url(); ?>/lte/http://adminlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
...
<!-- AdminLTE App -->
<script src="<?php echo base_url(); ?>/lte/dist/js/adminlte.js"></script>
