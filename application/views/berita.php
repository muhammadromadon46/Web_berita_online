                ...
                <div class="col-12 col-xl-8">
                    <div class="post-details-content bg-white mb-30 p-30 box-shadow">
                        <div class="blog-thumb mb-30">
                            <img src="<?php echo base_url(); ?>/assets/img/bg-img/50.jpg" alt="">
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4">
                                    <img class="mb-15" src="<?php echo base_url(); ?>/assets/img/bg-img/51.jpg" alt="">
                                </div>
                            </div>
                            ...
                            <div class="post-author d-flex align-items-center">
                                <div class="post-author-thumb">
                                    <img src="<?php echo base_url(); ?>/assets/img/bg-img/52.jpg" alt="">
                                </div>
                        ...
                        <ol>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="<?php echo base_url(); ?>/assets/img/bg-img/53.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="<?php echo base_url(); ?>/assets/img/bg-img/54.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <a href="#" class="comment-date">27 Aug 2019</a>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    <!-- Comment Author -->
                                    <div class="comment-author">
                                        <img src="<?php echo base_url(); ?>/assets/img/bg-img/55.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                    <div class="comment-meta">
                                        <a href="#" class="comment-date">27 Aug 2019</a>
