  <div class="hero-area owl-carousel">
        <!-- Single Blog Post -->
        <div class="hero-blog-post bg-img bg-overlay" style="background-image: url(<?php echo base_url(); ?>/assets/img/bg-img/berita.jpg);">
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        ...
                        <div class="post-content text-center">
                            ...
                            <a href="video-post.html" class="post-title" data-animation="fadeInUp" data-delay="300ms">BERITAINS</a>
                        ...
                        <div class="col-12 col-lg-7">
                            ...
                            <div class="single-featured-post">
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="<?php echo site_url('Home/isi_berita'); ?>" class="post-title">A Closer Look At Our Front Porch Items From Lowe’s</a>
